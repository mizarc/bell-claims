...
class ClaimDescriptionMenu(private val menuNavigator: MenuNavigator, private val player: Player,
    ...
    override fun open() {
        ...
        val gui = AnvilGui(localizationProvider.get(playerId, LocalizationKeys.MENU_DESCRIPTION_TITLE))
