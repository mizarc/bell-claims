...
class Config(val plugin: Plugin) {
    ...
    var visualiserHideDelayPeriod = 0
    var visualiserRefreshPeriod = 0
    ...
    fun loadConfig() {
        ...
        visualiserHideDelayPeriod = configFile.getInt("visualiser_hide_delay_period")
        visualiserRefreshPeriod = configFile.getInt("visualiser_refresh_period")
