...
interface VisualisationService {
    fun displayComplete(playerId: UUID, areas: Set<Area>): Set<Position3D>
    fun displayPartitioned(playerId: UUID, areas: Set<Area>): Set<Position3D>
    fun displayOthers(playerId: UUID, areas: Set<Area>): Set<Position3D>
